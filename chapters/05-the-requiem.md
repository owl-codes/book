...
Wick felt it too. The owl's head snapped upward — a sharp, ninety-degree tilt — and his frequency flared in a pattern Kael now recognized as the corvaxis threat-classification matrix: *size, speed, intent, capability.* The owl's assessment came through in a dense burst that was not directed at Kael but that he caught the edges of anyway.
